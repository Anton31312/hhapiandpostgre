...
def create_tables(database_name, params):
    """
    Функция для создание базы данных и таблиц для сохранения данных о вакансиях и работодателях.

    :param: database_name - str, params - list
    """
    ...
    conn.close()
    params.update({'database': database_name})
